                ...
                <div class="row gy-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <span class="caption-text">
                            {{ data_get($details, 'tnx_fees') }} <em class="text-soft icon ni ni-info fs-12px nk-tooltip" title="{{ __(':flat + :percent fee applied', ['flat' => data_get($transaction, 'meta.fees.calc.fx') . ' '.data_get($details, 'tnx_currency'), 'percent' => data_get($transaction, 'meta.fees.calc.pc'). '%' ]) }}"></em>
                        </span>
                    </div>
                    @endif
