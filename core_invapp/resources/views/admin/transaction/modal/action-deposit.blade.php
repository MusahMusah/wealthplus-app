...
$user_amount = money($transaction->tnx_total, $transaction->tnx_currency);

if($transaction->tnx_currency!=base_currency()) {
    $user_amount = money($transaction->tnx_total, $transaction->tnx_currency) . ' ('. money($transaction->total, $transaction->currency). ')';
}
        	...
        	<div class="col-sm-6">
        		<div class="form-group">
                    ...
                    <div class="form-control-wrap">
                        ...
                        <input type="text" value="{{ data_get($transaction, 'tnx_total') }}" class="form-control" readonly="">
                    </div>
                    <div class="form-note">
