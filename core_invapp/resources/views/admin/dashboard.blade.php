...
@section('content')
    <div class="nk-content-body">
        ...
        @if(!count(available_payment_methods()) > 0 || count($pending) > 0)
        <div class="nk-block">
                                ...
                                @if(filled($transactions['investments']))
                                    ...
                                    <div class="nk-tb-item">
                                        ...
                                        <div class="nk-tb-col">
                                            ...
                                            <div class="date">{{ show_date($iv->created_at) }} <span class="d-none d-sm-inline">{{ show_time($credit->created) }}</span></div>
                                        </div>
