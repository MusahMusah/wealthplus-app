...
class Transaction extends Model
{
    ...
    public function getShortcutDetailsAttribute()
    {
        ...
        $data["Payment Amount"] = money($this->tnx_total, $this->tnx_currency);
    ...
    public function getDetailsAttribute()
    {
        ...
        $data = [
            ...
            'fees' => ($this->fees) ? money($this->fees, $base_currency) : 0,
            'total' => money($this->total, $base_currency),
            // original
            'currency_base' => $this->currency,
            'amount_base' => money($this->amount, $this->currency),
            'fees_base' => ($this->fees) ? money($this->fees, $this->currency) : 0,
            'total_base' => money($this->total, $this->currency),
            // user tnx
            'tnx_amount' => money($this->tnx_amount, $this->tnx_currency),
            'tnx_total' => money($this->tnx_total, $this->tnx_currency),
            'tnx_fees' => ($this->tnx_fees) ? money($this->tnx_fees, $this->tnx_currency) : 0,
