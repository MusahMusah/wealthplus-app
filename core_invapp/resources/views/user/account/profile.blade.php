                        ...
                        <div class="data-col">
                            ...
                            <span class="data-value">
                                ...
                                @if (!empty($ctystzip))
                                    <br>{!! join(', ', $ctystzip) !!}
                                @endif
                                {{ ((!empty($metas['profile_zip']) && !empty($ctystzip)) ? '- ' : '') . data_get($metas,'profile_zip') }}
                            </span>
                        </div>
                        <div class="data-col data-col-end">
                            <span class="data-more{{ (profile_lockable()) ? ' disable' : '' }}"><em class="icon ni ni-{{ (profile_lockable()) ? 'lock-alt' : 'forward-ios' }}"></em></span>
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="profile_gender" class="form-select" id="gender" data-ui="lg"{{ (profile_lockable()) ? ' disabled' : '' }}>
                                                    <option value="0" {{ (isset($metas['profile_gender']) && empty($metas['profile_gender'])) ? ' selected' : '' }}>{{ __('Please select') }}</option>
                                ...
                                <div class="row gy-4"> 
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="profile_country" class="form-select" id="address-county" data-ui="lg" data-search="on"{{ (profile_lockable()) ? ' disabled' : '' }}>
