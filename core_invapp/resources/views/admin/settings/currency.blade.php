                                            ...
                                            <div class="col-md-4 col-sm-6">
                                                <div class="form-group">
                                                    <div class="form-control-wrap">
                                                        ...
                                                        <input name="manual_exchange_rate[{{ $code }}]" type="text" class="form-control" value="{{ data_get($manual_ex_rates, $code, 1) }}">
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
                                        ...
                                        @foreach($currencies as $code => $name)
                                            ...
                                            <div class="col-md-4 col-sm-6">
                                                <div class="form-group">
                                                    <div class="form-control-wrap">
                                                        <span class="form-text-hint"><span>{{ $code }}</span></span>
                                                        <input name="" type="text" class="form-control" value="{{ data_get($automatic_ex_rates, $code, 1) }}" readonly="readonly">
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
