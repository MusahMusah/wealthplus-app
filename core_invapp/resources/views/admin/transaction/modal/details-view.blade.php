                ...
                <div class="col-12">
                    ...
                    <span class="caption-text">
                        ...
                        <span class="small text-soft">
                            ...
                            <em class="icon ni ni-info fs-13px nk-tooltip" title="{{ __(':flat + :percent fee applied', ['flat' => data_get($tnx, 'meta.fees.calc.fx') . ' '.$tnx_currency, 'percent' => data_get($tnx, 'meta.fees.calc.pc'). '%' ]) }}"></em>
                        </span>
                        @endif
                    </span>
                </div>
